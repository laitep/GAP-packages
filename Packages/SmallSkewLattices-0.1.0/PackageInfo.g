...
##  <!ENTITY ARCHIVENAME "SmallSkewLattices-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallSkewLattices",
Subtitle := "Small SkewLattices in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallSkewLattices-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallSkewLattices-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallSkewLattices package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic SkewLattices ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallSkewLattices",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallSkewLattices Package: SkewLattices of small orders for GAP",
...
Keywords := ["SmallSkewLattices"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallSkewLattices Package",
