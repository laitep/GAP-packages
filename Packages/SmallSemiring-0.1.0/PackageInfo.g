...
##  <!ENTITY ARCHIVENAME "SmallSemiring-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallSemiring",
Subtitle := "Small Semiring in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallSemiring-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallSemiring-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallSemiring package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic Semiring ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallSemiring",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallSemiring Package: Semiring of small orders for GAP",
...
Keywords := ["SmallSemiring"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallSemiring Package",
