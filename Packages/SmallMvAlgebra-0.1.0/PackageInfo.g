...
##  <!ENTITY ARCHIVENAME "SmallMvAlgebra-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallMvAlgebra",
Subtitle := "Small MvAlgebra in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallMvAlgebra-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallMvAlgebra-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallMvAlgebra package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic MvAlgebra ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallMvAlgebra",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallMvAlgebra Package: MvAlgebra of small orders for GAP",
...
Keywords := ["SmallMvAlgebra"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallMvAlgebra Package",
