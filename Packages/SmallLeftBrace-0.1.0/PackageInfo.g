...
##  <!ENTITY ARCHIVENAME "SmallLeftBrace-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallLeftBrace",
Subtitle := "Small LeftBrace in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallLeftBrace-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallLeftBrace-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallLeftBrace package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic LeftBrace ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallLeftBrace",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallLeftBrace Package: LeftBrace of small orders for GAP",
...
Keywords := ["SmallLeftBrace"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallLeftBrace Package",
