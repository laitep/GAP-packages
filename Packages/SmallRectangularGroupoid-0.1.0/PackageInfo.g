...
##  <!ENTITY ARCHIVENAME "SmallRectangularGroupoid-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallRectangularGroupoid",
Subtitle := "Small RectangularGroupoid in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallRectangularGroupoid-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallRectangularGroupoid package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic RectangularGroupoid ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallRectangularGroupoid",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallRectangularGroupoid Package: RectangularGroupoid of small orders for GAP",
...
Keywords := ["SmallRectangularGroupoid"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallRectangularGroupoid Package",
