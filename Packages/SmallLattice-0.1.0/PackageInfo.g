...
##  <!ENTITY ARCHIVENAME "SmallLattice-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallLattice",
Subtitle := "Small Lattice in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallLattice-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallLattice-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallLattice package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic Lattice ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallLattice",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallLattice Package: Lattice of small orders for GAP",
...
Keywords := ["SmallLattice"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallLattice Package",
