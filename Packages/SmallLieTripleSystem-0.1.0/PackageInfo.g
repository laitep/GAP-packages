...
##  <!ENTITY ARCHIVENAME "SmallLieTripleSystem-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallLieTripleSystem",
Subtitle := "Small LieTripleSystem in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallLieTripleSystem-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallLieTripleSystem package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic LieTripleSystem ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallLieTripleSystem",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallLieTripleSystem Package: LieTripleSystem of small orders for GAP",
...
Keywords := ["SmallLieTripleSystem"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallLieTripleSystem Package",
