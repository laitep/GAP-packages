...
##  <!ENTITY ARCHIVENAME "SmallDeductiveAlgebra-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallDeductiveAlgebra",
Subtitle := "Small DeductiveAlgebra in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallDeductiveAlgebra-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallDeductiveAlgebra package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic DeductiveAlgebra ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallDeductiveAlgebra",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallDeductiveAlgebra Package: DeductiveAlgebra of small orders for GAP",
...
Keywords := ["SmallDeductiveAlgebra"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallDeductiveAlgebra Package",
