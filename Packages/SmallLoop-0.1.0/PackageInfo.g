...
##  <!ENTITY ARCHIVENAME "SmallLoop-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallLoop",
Subtitle := "Small Loop in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallLoop-0.1.0/PackageInfo.g" ),
...
"The SmallLoop package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic Loop ",
...
PackageDoc := rec(
  ...
  LongTitle := "The SmallLoop Package: Loop of small orders for GAP",
...
AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallLoop Package",
