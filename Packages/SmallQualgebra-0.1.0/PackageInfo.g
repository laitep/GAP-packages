...
##  <!ENTITY ARCHIVENAME "SmallQualgebra-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallQualgebra",
Subtitle := "Small Qualgebra in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallQualgebra-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallQualgebra-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallQualgebra package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic Qualgebra ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallQualgebra",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallQualgebra Package: Qualgebra of small orders for GAP",
...
Keywords := ["SmallQualgebra"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallQualgebra Package",
