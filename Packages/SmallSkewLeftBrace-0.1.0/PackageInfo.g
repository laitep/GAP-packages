...
##  <!ENTITY ARCHIVENAME "SmallSkewLeftBrace-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallSkewLeftBrace",
Subtitle := "Small SkewLeftBrace in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallSkewLeftBrace-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallSkewLeftBrace-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallSkewLeftBrace package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic SkewLeftBrace ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallSkewLeftBrace",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallSkewLeftBrace Package: SkewLeftBrace of small orders for GAP",
...
Keywords := ["SmallSkewLeftBrace"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallSkewLeftBrace Package",
