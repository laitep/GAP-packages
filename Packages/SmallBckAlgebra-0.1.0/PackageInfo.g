...
##  <!ENTITY ARCHIVENAME "SmallBckAlgebra-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallBckAlgebra",
Subtitle := "Small BckAlgebra in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallBckAlgebra-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallBckAlgebra-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallBckAlgebra package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic BckAlgebra ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallBckAlgebra",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallBckAlgebra Package: BckAlgebra of small orders for GAP",
...
Keywords := ["SmallBckAlgebra"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallBckAlgebra Package",
