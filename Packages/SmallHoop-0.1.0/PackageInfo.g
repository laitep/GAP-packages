...
##  <!ENTITY ARCHIVENAME "SmallHoop-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallHoop",
Subtitle := "Small Hoop in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallHoop-0.1.0/PackageInfo.g" ),
...
"The SmallHoop package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic Hoop ",
...
PackageDoc := rec(
  ...
  LongTitle := "The SmallHoop Package: Hoop of small orders for GAP",
...
AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallHoop Package",
