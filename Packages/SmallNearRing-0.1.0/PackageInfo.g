...
##  <!ENTITY ARCHIVENAME "SmallNearRing-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallNearRing",
Subtitle := "Small NearRing in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallNearRing-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallNearRing-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallNearRing package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic NearRing ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallNearRing",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallNearRing Package: NearRing of small orders for GAP",
...
Keywords := ["SmallNearRing"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallNearRing Package",
