...
##  <!ENTITY ARCHIVENAME "SmallMoufangLoop-0.1.0">
##  <#/GAPDoc>

SetPackageInfo( rec(
PackageName := "SmallMoufangLoop",
Subtitle := "Small MoufangLoop in GAP",
Version := "0.1.0",
Date := "19/01/2025",
...
PackageInfoURL  := Concatenation( ~.PackageWWWHome,"SmallMoufangLoop-0.1.0/PackageInfo.g" ),
...
ArchiveURL      := Concatenation( ~.SourceRepository.URL,
                                 ...
                                 "/SmallMoufangLoop-", ~.Version ),
ArchiveFormats := ".tar.gz",

AbstractHTML := Concatenation(
"The SmallMoufangLoop package provides researchers in computational algebra ",
"with a computational tool to access the non-isomorphic MoufangLoop ",
"in the computational algebra system GAP."
),

PackageDoc := rec(
  BookName  := "SmallMoufangLoop",
  ArchiveURLSubset := ["doc"],
  HTMLStart := "doc/chap0_mj.html",
  PDFFile   := "doc/manual.pdf",
  SixFile   := "doc/manual.six",
  LongTitle := "The SmallMoufangLoop Package: MoufangLoop of small orders for GAP",
...
Keywords := ["SmallMoufangLoop"],

AutoDoc := rec(
    TitlePage := rec(
        Title := "The Small SmallMoufangLoop Package",
